...
results = ['']
for o in orders:
	results[0] = 'contract,GM1%,SPC2014,SPC_A,SPC_B,SPC_C,SPC_D'
	result = "%s,%.4f,%.2f," %(o.contract,o.gm1_per,o.get_bonus2014())
...
save_to_file('sis_test_true',buffer_str)


samples = ['contract,MP,GM1%,SPC2014,SPC_A,SPC_B,SPC_C,SPC_D,']
for o in orders:
	origin_mp = o.mp
	for mp_key in range(100,2000):
		o.set_mp(origin_mp*mp_key/1000)
		if o.gm1_per >= 0.05 and o.gm1_per <=0.2:
			sample = '%s,%.2f,%.4f,%.2f,' %(o.contract,o.mp,o.gm1_per,o.get_bonus2014())
...
for s in samples:
	buffer_str += s+'\n'
save_to_file('sis_test_samples',buffer_str)
